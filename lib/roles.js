...
export const ROLES = [
  ...
  },
  {
    ...
    camp: "loups",
    description:
      "Tu te réveilles avec les autres loups-garous mais ils ignorent qui tu es. Une nuit sur deux, tu peux en plus dévorer secrètement un autre loup-garou. Tu ne gagnes pas avec la meute : tu dois être le dernier survivant, seul contre tous.",
  },
];
